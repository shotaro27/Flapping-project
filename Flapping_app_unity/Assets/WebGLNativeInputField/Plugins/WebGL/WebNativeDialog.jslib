var WebNativeDialog = {
  ...
  SetupOverlayDialogHtml:function(title,defaultValue,okBtnText,cancelBtnText){
    ...
    if( !document.getElementById("nativeInputDialog" ) ){
      // setup html
      var html = '<div id="nativeInputDialog" style="background:#000000;opacity:0.9;position:fixed;top:0%;z-index:2147483647;">' + 
    ...
    document.getElementById("nativeInputDialogInput").style.fontSize = "18px";
